...
- A persistent fleet toolbar in the hidden navigation provides quick filtering, Smart-first sorting, a column chooser, resizable row columns, and the Cards/Rows switch.
